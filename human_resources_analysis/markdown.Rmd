...
**Recruitment**
 ...
 The data covers the years 2006 to 2017. This graph shows when hires were made in this time period. 
```{r echo = FALSE}
hr <- hr %>% 
