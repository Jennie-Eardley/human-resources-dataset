...
The vast majority of employees' performance is rated as "fully meets" (78%). 12% of employees have a score of exceeds and 6% and 4% have a score of needs improvement and pip respectively. 
```{r echo = FALSE}
...
round(fully_meets/total_employees * 100)
round(exceeds/total_employees * 100)
round(pip/total_employees * 100)
round(needs_improvement/total_employees * 100)
```
