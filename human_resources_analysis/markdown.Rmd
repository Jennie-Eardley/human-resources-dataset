...
**Recruitment**
 ...
 The data covers the time period of 2006 to 2017. This graph shows the dates that hires were made. The month with the highest number of new recruits was in September of 2011 with 15 new recruits. 
...
The data indicates that participation in the Diversity Job Fair is successful in attracting more racially diverse candidates. 
...
Employee satisfaction is measured on a scale of 1-5, with 5 indicating the highest satisfaction. Across the dataset, the median scoring for employee satisfaction is 4. The data gives numerous variables which could have an impact on employee satisfaction. The report considers the impact of different factors in influencing employee satisfaction. Firstly, the impact of pay on satisfaction. The plot does not suggest that there is much of a correlation between employee satisfaction and their payrate as the data is very spread out. 
...
This can also be broken down to see if there are months that staff are more likely to leave during. 
